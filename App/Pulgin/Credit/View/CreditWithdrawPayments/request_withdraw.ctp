...
<div class="modal-body">
    ...
    <div class="row">
		<div class="col-md-12">
            <button class="btn btn-action btn-request-withdraw"  data-url="<?php echo $this->base.'/credits/credit_withdraw_payments'; ?>" title="Submit"> <?php echo __d('credit', 'Submit'); ?> </button>
