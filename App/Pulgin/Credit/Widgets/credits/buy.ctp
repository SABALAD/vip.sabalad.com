...
<div class="box2 buy_credit">
    ...
    <div class="box_content ">
       ...
       <div class="btt_buy_credit">
            <a class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored1" href="<?php echo $this->request->base?>/credits/ajax_sell" data-target="#themeModal" data-toggle="modal" class="" title="<?php echo __d('credit', 'Buy Creditss')?>"><?php echo __d('credit', 'Buy Creditss')?>! </a>
       </div>
	</div>
</div>
<?php endif;?>
