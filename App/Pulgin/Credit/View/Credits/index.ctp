        ...
        <ul class="list2 menu-list">
            ...
            <?php if (!empty($uid)): ?>
                <li class="<?php echo (isset($my_withdraw_requests)) ? $my_withdraw_requests : ""; ?>">
                    <a href="<?php echo $this->request->base ?>/credits/index/my_withdraw_requests"><?php echo __d('credit', 'My withdrawal requests') ?></a>
                </li>
            <?php endif; ?>
        </ul>
    </div>
        ...
        <div <?php if($type != "faqs"):?>id="list-content"<?php endif;?>>
            ...
            switch ($type){
                ...
                case 'my_withdraw_requests':
                    echo $this->element( 'list/my_withdraw_requests');
                    break;
                default:
