...
<div class="bar-content">
    <div class="content_center">
    	<div id="list-content">
		    ...
		    <div class="row">
				<div class="col-md-12">
		            <button class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised mdl-button--colored1 btn-request-withdraw-edit"  data-url="<?php echo $this->base.'/credits/credit_withdraw_payments'; ?>" title="Submit"> <?php echo __d('credit', 'Submit'); ?> </button>
		        </div>
			</div>
			<div class="row">
				<div class="col-md-12">
