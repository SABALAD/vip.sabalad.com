                    ...
                    <div class="extra-info">
                        <div>
                            <strong><?php echo __d('credit', 'Current Balance'); ?>
                                : <?php echo round($user['CreditBalances']['current_credit'],8) ?></strong>
                        </div>
                        <div><?php echo __d('credit', 'Total Earned Credits'); ?>
                            : <?php echo round($user['CreditBalances']['earned_credit'],8) ?></div>
                        <div><?php echo __d('credit', 'Total Spent Credits'); ?>
                            : <?php echo round($user['CreditBalances']['spent_credit'],8) ?></div>
                    </div>
                </div>
            </li>
            <?php $i++;endforeach; ?>
