    	...
    	<div id="list-content">
				            ...
				            <div class="badge-info">
				                <div class="badge-rank">
				                    <div class="badge-rank-now" style="width: <?php echo $width_rank;?>%;">
				                        <?php echo round($item['CreditBalances']['current_credit'],8);?>
				                    </div>
				                </div>
				                <?php if(!empty($next_rank)):?>
				                <div class="badge-rank-next">
				                        <?php echo round($next_rank['CreditRanks']['credit'],8);?>
				                </div>
				                <?php endif;?>
				            </div>
				            <?php if(!empty($next_rank)):?>
			...
			<div class="send_credit">
    			<ul class="credit-content-list">
    				<li class="full_content p_m_10">	    			
						<div class="mo_breadcrumb">
		    				<h3 style="margin: 0;"><?php echo __d('credit', 'Buyasfasf Credits'); ?></h3>
		    			</div>	    	
					    <div class="box_content ">
				            ...
				            <div class="create_form">
				                <form id="sendCredits">
				                    <ul class="list6 list6sm2" style="position:relative">
				                        ...
				                        <li>
				                            <div class="col-sm-1">
				                                <a href="#" class="btn btn-action" id="sendButtonCredit"><?php echo __d('credit','Send Credits')?>
				                                </a>
				                            </div>
				                            <div class="clear"></div>
				                        </li>
