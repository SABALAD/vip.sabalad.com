...
(10, 'comment', 'Comment / Reply comment', 'Core', '1', '100', 1, 'model', 'Credit', 1),
(11, 'share', 'Share', 'Core', '1', '100', 1, 'none', 'Credit', 1),
(12, 'activity_comment', 'Comment status / Reply comment status', 'Core', '1', '100', 1, 'model', 'Credit', 1),
...
(22, 'post_new_feed', 'Post news feed', 'Activity', '10', '100', 1, 'model', 'Credit', 1),
(23, 'friend_inviter', 'Friend Inviter', 'Friend Inviter', '10', '1000', 0, 'none', 'Credit', 1),
(24, 'request_withdrawal_accepted', 'Withdrawal request', 'Credit', '0.00', '0', '0', 'none', 'Credit', '0');
...
CREATE TABLE `{PREFIX}credit_exchanges` (
  `id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
